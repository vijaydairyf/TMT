...
Rem
Rem    DESCRIPTION
Rem      Список табелей Пользователя.
Rem
Rem    MODIFIED   (YYMMDD)
Rem    appler      160516 - Created.

prompt ... creating view "MY_TIMETABLES_LIST"
create or replace view MY_TIMETABLES_LIST as
select
 ...
 where tmt.dept_id = d.id
   and (tmt.company_id, tmt.dept_id) in (select company_id, dept_id from users_depts ud where ud.username = V('APP_USER'))
;
